#' Logistic GRM への変換
#'
#' 重み付き最小２乗法を用いた Logistic GRM への変換 \cr
#' English help file: (\link[lazy.irt]{conv2G})
#'
#' @usage conv2G( param, theta=NULL, init=1, paramG=NULL
...
#' @return 以下のものからなるリスト
#' \preformatted{
#' paramNew: logistic GRM 項目パラメタデータフレーム
...
#'  \code{icrf_GRM(theta|PARAM)} は logistic GRM の icrf, そして\cr
...
#' \code{info_ic_GRM(theta|PARAM)} は logistic GRM の icif である。 \cr
#'
...
#'  \code{info_i_GRM(theta|PARAM)} は logistic GRM の iif である。 \cr
#'
#' \cr
