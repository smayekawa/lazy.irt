...
#'
#' @usage iif( param, theta=NULL, npoints=31, thmin=-4, thmax=4
...
#' @param npoints 離散点の数
#' @param numderiv = 1 irf の１次の数値微分を用いる。
#' @param print = 1 要約の出力\cr
#' = 2 テスト情報関数 (tif) の出力. \cr
#' = 3 項目情報関数 (iif) の出力. \cr
#' = 4 項目カテゴリ情報関数 (icif) の出力.
#' @param plot = 1 tif のプロット\cr
#' = 2 iif のプロット. \cr
#' = 3 局所的最適重みと項目カテゴリ重みのプロット.
#' @param legend = 0 レジェンドの印刷をしない。
#' @param maxinfo = プロットにおける情報関数の最大値.
