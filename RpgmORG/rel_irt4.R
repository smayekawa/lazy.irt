...
#' var(T) = var(TCC) \cr
#' \cr
#' For thetahat based score: Y = thetahat = theta + error \cr
#' var(error) = E(var(error|theta)) = var(Y|theta) = 1/info \cr
#' var(Y) = E(var(Y|theta)) + var(E(Y|theta)) \cr
#'               = E(1/info) + var(theta)  \cr
#' var(theta) = 1 or var(uniform)\cr
#'
#' \cr
