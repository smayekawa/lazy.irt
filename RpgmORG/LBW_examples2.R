...
param[3,3:7]=c(3,1,-2,-1,NA)
param[3,3:7]=c(3,1,-0.5,0.5,NA)
pres=fitP2G_ls( param[3,], plot=1, npoint=51 )
param[4,]=pres$paramP
param[4,"name"]="Q31p"
param=param[,1:(3+max(param$ncat))]
#param[2,"type"]="P"
#param[2,"p1"]=0.802
...
resInfo=info_func( param, plot=3, print=3
                   , thmin=-3, thmax=3, npoints=151, numderiv=0 )

matplot(theta,cbind(icrf[,5:7],v_LO[,5:7]), type="l", col=1:3)
temp=irf(param,theta,plot=1,print=0)
...
comment(
 ...
 i0=icrf[,3:4]
 v0=d0/i0
 matplot( theta, v0, type="l", main="3PLM")
 ...
 v2=d2/i2
  ...
  matplot( theta, d1, type="l", main="GRM P`(theta)")
  matplot( theta, d2, type="l", main="GPCM P`(theta)")

 matplot( theta, v1, type="l", main="GRM Basic Function")
 matplot( theta, v2, type="l", main="GPCM Basic Function")
