...
#   temp=rep(1,npoints)
 ...
 else if( is.vector(thd) ) thd=matrix(thd,,1)
...
res1 <- LRT( Uc, maxiter=1000, SQUAREM=0, print=3, npoints=npoints, estmu=1 )

res2 <- LRT( Uc, maxiter=1000, SQUAREM=0, print=3, npoints=npoints, estmu=1, thd=rep(1/npoints, npoints) )
