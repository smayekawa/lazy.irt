...
#' Information Functions. \cr
#' Japanese help file: (\link[lazy.irt]{iif_JPH})
#'
#'
...
#'  \eqn{ P''_{kj}(\theta) } \cr
#' where \eqn{P_{kj}(\theta)} is the item category response function and 
#' \eqn{P'_{kj}(\theta)} is the first derivative of \eqn{P_{kj}(\theta)}.
#'  \cr
...
#'
#' Above corresponds to the information functions from \code{info_func}
#' or \code{obscore} associated with locally best item category weights (LO).
#'
#'
#'
#' @references
...
iif <- function( param, theta=NULL, npoints=31, thmin=-4, thmax=4
 ...
 # roxgen2: 20230329
 # JPH: 20231028cot
 # roxugen2: definition of icif corrected: 20231029cot
 #
 # Args:
