...
#'
#' @details
#' This function finds the set of Logistic GRM item paramters
...
fitG2P_ls <- function( paramP, theta=NULL, init=1, paramG=NULL
 ...
 grad=t(grad)
  ...
  for( j in 1: nitems ){
   ...
   res=GN( paramj, ymyhat, ww, method=method, print=max(0,print-1) )
   paramj=res$par
   llll=res$iterations
   g=res$grad
   rss=res$objective
...
res2=fitG2P_ls( paramA1[8,], theta, plot=1, print=1, wtype=1, method=0, init=0 )
...
res0=fitG2P_ls( itemparam, theta, plot=4, print=1, wtype=1, method=0, init=0 )
rmse_p0=res0$rmse_p; rmse_ii0=res0$rmse_ii; rmse_iic0=res0$rmse_iic

res1=fitG2P_ls( itemparam, theta, plot=4, print=1, wtype=1, method=1, init=0 )
rmse_p1=res1$rmse_p; rmse_ii1=res1$rmse_ii; rmse_iic1=res1$rmse_iic

res2=fitG2P_ls( itemparam, theta, plot=4, print=1, wtype=1, method=2, init=0 )
