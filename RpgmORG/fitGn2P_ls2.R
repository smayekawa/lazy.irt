...
#' paramG: Normal GRM Item Parameter Data Frame (type="G")\cr
...
#' res0 <- fitGn2P_ls( param, theta, maxiter=20, plot=1, wtype=1, info=0 )
#' res1 <- fitGn2P_ls( param, theta, maxiter=20, plot=1, wtype=1, info=1 )
#'
...
fitGn2P_ls <- function( paramP, theta=NULL
...
# res=fitGn2P_ls( param, theta, plot=1, print=2, maxiter=50, wtype=1, info=0 )
res=fitGn2P_ls( param, theta, plot=1, print=1, wtype=1, info=1 )
