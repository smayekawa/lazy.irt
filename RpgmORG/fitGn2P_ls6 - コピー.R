...
fitGn2P_ls <- function( paramP, theta=NULL, init=1, paramG=NULL
 ...
 info_ic <- function( paramnum ){
  ...
  infovv=vec( iif( paramjdf, theta, print=0 )$info_item_cat_LO )
  return( infovv )
 } # end of info_ic
 ...
 ic_infoP=iif( paramP, theta, print=0 )$info_item_cat_LO
 ...
 ic_infoG=iif( paramG, theta, print=0 )$info_item_cat_LO
...
res2=fitGn2P_ls( paramA1[8,], theta, plot=1, print=1, wtype=1, method=0, init=0 )
...
res0=fitGn2P_ls( itemparam, theta, plot=4, print=1, wtype=1, method=0, init=0 )
rmse_p0=res0$rmse_p; rmse_ii0=res0$rmse_ii; rmse_iic0=res0$rmse_iic

res1=fitGn2P_ls( itemparam, theta, plot=4, print=1, wtype=1, method=1, init=0 )
rmse_p1=res1$rmse_p; rmse_ii1=res1$rmse_ii; rmse_iic1=res1$rmse_iic

res2=fitGn2P_ls( itemparam, theta, plot=4, print=1, wtype=1, method=2, init=0 )
