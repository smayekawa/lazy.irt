...
flatten_SEM <- function( out_obscore=NULL, sigma=1, by_s=0.1
 ...
 # pint ncat: 20170314
 # u -> s: 20170417
 # Print removed: 20171214
 #

 # Y = g(X)

 get_gdash <- function( t ){
  # derivative of s=g(t): g'(t)=gd0=sigma/stdx_TRF(t)
 ...
 if( print ){
  ...
  Print( t, stdx_t, s, gdash, stdy_s )
  Print( brk_x2u )
 }

 res=named_list( t, stdx_t, s, gdash, stdy_s, lengtht, sigma, brk_x2u
...
res2=flatten_SEM( param=pp, sigma=1, plot=1, print=1, npoints=151
, thmin=-3, thmax=3 )
