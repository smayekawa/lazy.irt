...
#' @param   alpha = vector of Dirichle parameters of length nclass
...
res1 <- nIRT( Uc, maxiter=1000, print=1, nclass=nclass, estrho=1, monotone=0 )

resm1 <- nIRT( Uc, maxiter=1000, print=1, nclass=nclass, estrho=1, monotone=1 )
