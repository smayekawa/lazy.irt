...
comments('
# must follow gen_caldata3.R
paramCal2=paramCal1
 paramCal2=paramCal1[grep("^B[[:digit:]]*$",paramCal1$type),]
# paramCal2=paramCal1[grep("^PN$",paramCal1$type),]


res=cala( indata=paramCal2, baseform=1, maxiter=1000, eps=1e-8
               , print=3, debug=0  )
') # end of comments


# must follow read_error.R
res=cala( indata=paramCal1, baseform=1, maxiter=1000, eps=1e-8
          , print=3, debug=0  )
