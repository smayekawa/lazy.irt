...
#'  info:   test information function\cr
#'  info_item:   item information function \cr
#'  info_item_cat:   item category information function
#'
#' @details
#' The item information function is defined as \cr
#' \eqn{  I_j(\theta) = \sum_k (P'_{kj}(\theta))^2 / P_{kj}(\theta) }
#' where \eqn{P_{kj}(\theta)} is the item category response function, \cr
#' and \eqn{P'_{kj}(\theta)} is its derivative. \cr
#' The test information function is the sum of the above:\cr
#'  \eqn{  I(\theta) = \sum_j \sum_k (P'_{kj}(\theta))^2 / P_{kj}(\theta) }.
#'
#' The item category information function (item response information function)
#' is defined as the 2nd derivative of \eqn{log(P_{kj}(\theta))} \cr
#' \eqn{ I_{kj}(\theta) = (P'_{kj}(\theta))^2 / P_{kj}(\theta) - }
#'  \eqn{ P''_{kj}(\theta) } \cr
#' where the second derivatives, \eqn{ P''_{kj}(\theta) }, will be calculated
#' numerically by \code{dirt_num} using \code{lazy.mat::JacobianMat}.
#'
#' Note that  \eqn{ I_j(\theta) = \sum_k I_{kj}(\theta) } and
...
res=iif( paramA1[8,], theta, plot=3, print=1 )
