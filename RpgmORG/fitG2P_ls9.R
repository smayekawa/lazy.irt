...
#'
#' @param paramP Item Parameter Data Frame with item types \cr
#'   "B3","Bn","Bn3","P", "Gn"
...
fitG2P_ls <- function( paramP, theta=NULL, init=1, paramG=NULL
 ...
 if( print >= 1 ){
  cat("\nFitting Logistic Graded Response Model"
 ...
 return( named_list( paramNew=paramG, paramOld=paramP, method
                    , rmse_p, rmse_ii, rmse_iic
...
res2=fitG2P_ls( paramA1[8,], plot=1, print=4, wtype=1, method=0, init=0 )
