...
res1m <- nIRT( Uc, maxiter=1000, print=1, nclass=nclass, estrho=1, monotone=1 )

res1$V[,c(2,4,6,8,10,12,14,16,18)]
res1m$V[,c(2,4,6,8,10,12,14,16,18)]
