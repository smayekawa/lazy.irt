...
fitGn2P_ls <- function( paramP, theta=NULL, init=1
 ...
 #
 #
 # Something is WRONG with inline weighte GN!!!!!
 #
 # Args:
 #
...
res=fitGn2P_ls( paramA1[8,], theta, plot=1, print=1, wtype=1, method=1, init=0 )
