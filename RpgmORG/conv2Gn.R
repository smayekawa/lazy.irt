...
temp=conv2Gn( paramA1[c(2,8,9),], plot=1, print=1, wtype=1, method=1, init=1 )
...
res20=fitGn2P_ls( paramA1[8,], plot=1, print=4, wtype=1, method=0, init=1 )
res2=conv2Gn( paramA1[8,], plot=1, print=4, wtype=1, method=1, init=1 )

res20=fitGn2P_ls( paramA1[8,], plot=1, print=4, wtype=1, method=2, init=1 )
res2=conv2Gn( paramA1[8,], plot=1, print=4, wtype=1, method=2, init=1 )
