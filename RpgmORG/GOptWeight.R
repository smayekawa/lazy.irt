...
#' weight.df( paramS1,res1 )
#'
#' res2 <- GOptWeight( paramS2 )
#' weight.df( paramS2,res2 )
#'
...
#' Convert a vector of category weights to weight data frame
#'
#' @param param Item parameter data frame
#' @param ws A vector of category weights (by item=row)
#'
#' @examples
#' weight.df( paramS1, 1:12)
#'
#'
#' @author Contributed by Dr. Sayaka Arai of DNC.
#'
