...
res0=fitGn2P_ls( itemparam, plot=4, print=1, npoints=51, method=0, init=0 )
rmse_p0=res0$rmse_p; rmse_ii0=res0$rmse_ii; rmse_iic0=res0$rmse_iic
param0=res0$paramG[,3+(1:ncat0)]

res1=fitGn2P_ls( itemparam, plot=4, print=1, npoints=51, method=1, init=0 )
rmse_p1=res1$rmse_p; rmse_ii1=res1$rmse_ii; rmse_iic1=res1$rmse_iic
param1=res1$paramG[,3+(1:ncat0)]

res2=fitGn2P_ls( itemparam, plot=4, print=1, npoints=51, method=2, init=0 )
rmse_p2=res2$rmse_p; rmse_ii2=res2$rmse_ii; rmse_iic2=res2$rmse_iic
param2=res2$paramG[,3+(1:ncat0)]
...
res0=fitP2G_ls( itemparam, plot=4, print=1, npoints=51, method=0, init=0 )
rmse_p0=res0$rmse_p; rmse_ii0=res0$rmse_ii; rmse_iic0=res0$rmse_iic
param0=res0$paramP[,3+(1:ncat0)]

res1=fitP2G_ls( itemparam, plot=4, print=1, npoints=51, method=1, init=0 )
rmse_p1=res1$rmse_p; rmse_ii1=res1$rmse_ii; rmse_iic1=res1$rmse_iic
param1=res1$paramP[,3+(1:ncat0)]

res2=fitP2G_ls( itemparam, plot=4, print=1, npoints=51, method=2, init=0 )
rmse_p2=res2$rmse_p; rmse_ii2=res2$rmse_ii; rmse_iic2=res2$rmse_iic
param2=res2$paramP[,3+(1:ncat0)]
...
title="P-G3"
itemparam=paramA1[5,]; ncat0=itemparam$ncat
res0=fitG2P_ls( itemparam, plot=4, print=1, npoints=51, method=0, init=0 )
rmse_p0=res0$rmse_p; rmse_ii0=res0$rmse_ii; rmse_iic0=res0$rmse_iic
param0=res0$paramG[,3+(1:ncat0)]

res1=fitG2P_ls( itemparam, plot=4, print=1, npoints=51, method=1, init=0 )
rmse_p1=res1$rmse_p; rmse_ii1=res1$rmse_ii; rmse_iic1=res1$rmse_iic
param1=res1$paramG[,3+(1:ncat0)]


res2=fitG2P_ls( itemparam, plot=4, print=1, npoints=51, method=2, init=0 )
rmse_p2=res2$rmse_p; rmse_ii2=res2$rmse_ii; rmse_iic2=res2$rmse_iic
param2=res2$paramG[,3+(1:ncat0)]
