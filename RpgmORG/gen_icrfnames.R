...
gen_icrfnames( theta, 3 )
gen_icrfnames( theta, 3, zero=1 )

gen_icrfnames( theta, 3, cat.first=1 )
gen_icrfnames( theta, 3, zero=1, cat.first=1 )

gen_icrfnames( theta, 3, compress=1 )
gen_icrfnames( theta, 3, zero=1, compress=1 )

gen_icrfnames( theta, 3, cat.first=1, compress=1 )
gen_icrfnames( theta, 3, zero=1, cat.first=1, compress=1 )


ncat=2
zero=1
cc=(1-zero):(ncat-1)
catname=paste( "c", cc, sep="" )
