...
#' the parametric (normal pdf) scored multinomial distribution. \cr
#' Japanese help file: (\link[lazy.irt]{smn_JPH})
#'
...
smn <- function( x, f, mu=NULL, sigma=NULL,    estmu=1, estsigma=1
 ...
 # plot: 121207
 # plot bugfix: 20150614,20170811cot
 # Diag -> diag: 20160811cot
 #
