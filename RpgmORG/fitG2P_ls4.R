...
fitG2P_ls <- function( paramP, theta=NULL, init=1
...
res=fitG2P_ls( paramA1, theta, plot=1, print=1, wtype=1, method=1, init=0 )
...
res=fitG2P_ls( param, theta, plot=1, print=1, wtype=1, method=2 )
