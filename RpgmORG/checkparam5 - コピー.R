...
#' checkparam(paramA1, type=c("B","P"), tomat=0 )
#' checkparam(paramA1, type=c("Bn2","G"), tomat=0 )
#'
#' @return
...
checkparam( paramA1, "B" , "checkparam", tomat=0 )
checkparam( paramA1, "Bn" , "checkparam", tomat=0)

checkparam( paramA1, c("B","P","Bn") , "checkparam", tomat=0 )
